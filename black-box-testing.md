...
## **My Self**
- การทดสอบระบบโดยอิงข้อมูลที่ป้อนเข้า (Input) และผลลัพธ์ที่ได้ (Output) เป็นกระบวนการตรวจสอบว่าระบบสามารถทำงานได้ตามความต้องการที่กำหนดไว้ โดยไม่พิจารณาโครงสร้างภายในหรือกระบวนการทำงานเบื้องหลังของระบบ 
